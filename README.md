...
A estrutura do projeto foi pensada para facilitar futuras manutenções e evoluções, priorizando um **código limpo e modular**. Os seguintes pontos demonstram isso:
